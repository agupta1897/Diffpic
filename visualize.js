...
{
    $.ajax({
        url: "https://api.github.com/repos/" + username + "/" + repository + "/" + commitId1 + "/contents/" + picName + "?access_token=" + access_tokenGlobal +"&scope=repo&token_type=bearer",
        method: "GET",
        success: function(response) {
            ...
            if(commitId2 != null){
                    ...
                    $.ajax({
                        url: "https://api.github.com/repos/" + username + "/" + repository + "/" + commitId2 + "/contents/" + picName + "?access_token=" + access_tokenGlobal +"&scope=repo&token_type=bearer",
                        method: "GET",
                        success: function(response) {
